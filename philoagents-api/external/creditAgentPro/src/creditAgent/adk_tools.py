...
def vectorSearch(query: str)-> str:
    ...
    index=load_faiss_index('/home/pnanda/chase_embeddings/credit_faiss.index')
    print("Index ntotal chunks:", index.ntotal)  # Should be num_chunks)
    embeddings, chunks, meta = load_embeddings_from_meta('/home/pnanda/chase_embeddings/creditembeddings_meta.json')
